...
test("declarative creation", async () => {
  ...
  const component = renderComponent(undefined, "<view>{{numA}}+{{numB}}={{sum}}</view>", (Component) => {
    Component({
...
test("binding multi store in custom components", async () => {
  ...
  const component = renderComponent(undefined, "<view><text>{{a_A}}+{{b_A}}={{sum_A}}</text><text>{{a_B}}+{{b_B}}={{sum_B}}</text></view>", (Component) => {
    Component({
      behaviors: [storeBindingsBehavior],
      storeBindings: [
        {
...
test("structural comparison", async () => {
  ...
  const component = renderComponent(undefined, "<view>{{nums.a}}+{{nums.b}}</view>", (Component) => {
    Component({
      behaviors: [storeBindingsBehavior],
      storeBindings: {
